...
import { verifyAccessToken, verifyEmailToken, verifyForgotPasswordToken, verifyRefreshToken, verifyTempToken } from '../middleware/jwtVerify.js';
...
router.post("/forgot-password-change", verifyTempToken, forgotPasswordChangeController); //Change the Password with a Token / auth/forgot-password-change

//PUT
router.put("/update", verifyAccessToken, updateUserController); //Update the User Profile /auth/update
...
router.get("/forgot-password-verify", verifyForgotPasswordToken, forgotPasswordVerifyController); //Verify Forogt Password Token from Email /auth/forgot-password-verify
router.get("/logout", verifyAccessToken, logoutController); //Logout the User /auth/logout
